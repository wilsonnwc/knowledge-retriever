...
|------|------|-------------|-----|------------------|-------|
| **01** Expectation prompt | Does the initial prompt clearly state: (1) what it does (searches *your notes*, not web), (2) what you should do (type a goal), (3) what output will be? | YES/NO | ☐ | ☐ ☐ ☐ ☐ ☐ | |
