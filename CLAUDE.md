...
- **Next:** Interview-defense drill still deferred (Session 12, 13, 14 items — now includes explaining the keyword-search retirement and the truncation bug). 5 deferred "Why this matters" TODOs remain across the two Kindle imports. Formal eval script not re-run since the two Kindle imports were added.
